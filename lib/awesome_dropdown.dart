...
class _AwesomeDropDownState extends State<AwesomeDropDown> with WidgetsBindingObserver{

  GlobalKey _gestureDetectorGlobalKey;
  double _gestureDetectorHeight, _gestureDetectorWidth, _gestureDetectorXPosition, _gestureDetectorYPosition;
  ...
  Widget build(BuildContext context) {
    if(widget.isBackPressedOrTouchedOutSide !=null && widget.isBackPressedOrTouchedOutSide
        && _isDropdownOpened){
      _openAndCloseDrawer();
  ...
  void findDropdownData() {
    RenderBox renderBox = _gestureDetectorGlobalKey.currentContext.findRenderObject();
  ...
  OverlayEntry _createFloatingDropdown(int numOfListItemToShow) {
    int numOfListItem = numOfListItemToShow != null && numOfListItemToShow <= 10
        && numOfListItemToShow <= widget.dropDownList.length? numOfListItemToShow : 4;
    double overlayHeight = _listItemHeight*widget.dropDownList.length+15, fourItemsHeight = numOfListItem*_listItemHeight+15;
    return OverlayEntry(builder: (context) {
      return Positioned(
        ...
        height: (_listItemHeight == 0.0 )?0.1:
        ...
        child: Container(
          ...
          child: SafeArea(
            child: DropDownOverlay(
              ...
              dropDownList: (widget.dropDownList!=null)?widget.dropDownList:List(),
...
class DropDownOverlay extends StatelessWidget{
  ...
  double getListItemHeight() {
    RenderBox renderBox = _listItemKey.currentContext.findRenderObject();
    ...
    return Card(
      ...
      child:  Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.only(topLeft: Radius.circular(0),topRight:Radius.circular(0),
              bottomLeft: Radius.circular(10.0), bottomRight: Radius.circular(10.0)),
          boxShadow: [BoxShadow(color: Colors.white,blurRadius: 0,spreadRadius: 0,offset: Offset(1,3))],
